...
<body class="min-h-screen">
  <div class="flex flex-col md:flex-row min-h-screen registration-container">
    <!-- Bagian kiri (biru) -->
    ...
    <div class="w-full md:w-1/2 bg-white flex flex-col items-center justify-center p-4 md:p-8">
      <div class="w-full max-w-sm p-4 md:p-6 bg-sky-200 rounded-xl shadow-lg">
        <h2 class="text-xl md:text-2xl font-bold text-center mb-6 text-gray-700">Daftar</h2>
